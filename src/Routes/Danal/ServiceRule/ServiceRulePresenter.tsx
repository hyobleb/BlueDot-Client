...
const ServiceRulePresenter: React.SFC = () => (
  <Back title={"Service-rule | BlueDot"} backUrl={"/"}>
    <Row>
      <RowTitle>
        **제1조(목적)** 이 약관은 ㈜크리플레이(전자상거래 사업자)가 운영하는
        블루닷라운지(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하
    ...
    <Row>
      ...
      <RowCont>
        <RowContLine>
          ① “몰”이란 ㈜크리플레이가 재화 또는 용역(이하 “재화 등”이라 함)을
    ...
    <Row>
      <RowTitle>**제9조(구매신청 및 개인정보 제공 동의 등)**</RowTitle>
      <RowCont>
        <RowContLine>
    ...
    <Row>
      <RowTitle>
        **제11조(지급방법)** “몰”에서 구매한 재화 또는 용역에 대한
        ...
        “몰”은 이용자의 지급방법에 대하여 재화 등의 대금에 어떠한 명목의
    ...
    <Row>
      <RowTitle>**제12조(수신확인통지․구매신청 변경 및 취소)**</RowTitle>
      <RowCont>
        <RowContLine>
    ...
    <Row>
      <RowTitle>**제19조(회원의 ID 및 비밀번호에 대한 의무)**</RowTitle>
      <RowCont>
        ① 제17조의 경우를 제외한 ID와 비밀번호에 관한 관리책임은 회원에게
        있습니다. ② 회원은 자신의 ID 및 비밀번호를 제3자에게 이용하게 해서는
        안됩니다. ③ 회원이 자신의 ID 및 비밀번호를 도난당하거나 제3자가 사용하고
    ...
    <Row>
      ...
      <RowCont>
        <RowContLine>1. 신청 또는 변경시 허위 내용의 등록</RowContLine>
...
export default ServiceRulePresenter;
